...
export const addProductToCart = (product) => postJson('/api/cart', { id: product.id });

export const removeProductFromCart = (product) => postJson('/api/removeProduct', { id: product.id });
